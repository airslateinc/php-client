...
/**
 * Class Inflector
 * @package AirSlate\ApiClient\Helpers
 */
class Inflector
{
    /**
     ...
     * @return string
     */
    public static function humanize($word, $ucAll = false): string
    {
     ...
     * @return string
     */
    public static function tableize($className): string
    {
     ...
     * @return string
     */
    public static function classify($tableName): string
    {
